...
The FarmTest library implements the **F**actor-**A**djusted **R**obust **M**ultiple **Test**ing method proposed by [Fan et al., 2019](https://www.tandfonline.com/doi/full/10.1080/01621459.2018.1527700). An earlier version can be found [here](https://github.com/kbose28/FarmTest). Let *X* be a *p*-dimensional random vector with mean *&mu;<sup>i</sup>*. This library carries out simultaneous inference on the *p* hypotheses *H<sub>0j</sub> : &mu;<sub>j</sub> = &mu;<sub>0j</sub>*.
